...
<Tabs>
    <Tab title="Powershell (Windows)">
        ...
        <Warning>
        If you need to delete the conda environment and start over, you can run the following commands:
        ```powershell
        conda deactivate
...
2. Access the ComfyUI web interface at [http://localhost:8188](http://localhost:8188). 
