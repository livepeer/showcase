...
export default function MyStreams({ searchParams }: { searchParams: any }) {
  ...
  const [selectedStreamIdForDelete, setSelectedStreamIdForDelete] = useState<
    string | null
  >(null);
  const limit = 10;
  ...
  const EmptyState = () => (
    <div className="flex justify-center h-[calc(100vh-15rem)] items-center">
      <div className="text-center">
        ...
        <Button
          onClick={() => router.replace(`/stream/create`)}
          className="mt-4"
        >
          Create Stream
        </Button>
              ...
              <TableBody>
                {streams.map((stream) => (
                  <TableRow key={stream.stream_key}>
                    ...
                    <TableCell>{stream.pipelines.name}</TableCell>
                    <TableCell>
                    ...
                    <TableCell className="flex items-center gap-x-4">
                      ...
                      <Dialog>
                        <Tooltip>
                          ...
                          <TooltipContent>View Stream Details</TooltipContent>
                        </Tooltip>
                            ...
                            <div className="mb-2">
                              ...
                              <div className="inline-flex items-center gap-x-2">
                                ...
                                <Copy
                                  ...
                                  className="mr-2 cursor-pointer"
                                  onClick={() =>
                                    copy(stream.output_playback_id)
                                  }
                                />
                              </div>
                            </div>
                            <div className="mb-2">
                              <div className="inline-flex items-center gap-x-2">
                                ...
                                <Copy
                                  ...
                                  className="mr-2 cursor-pointer"
                                  onClick={() =>
                                    copy(JSON.stringify(stream.pipeline_params))
                                  }
                                />
                              </div>
                            </div>
                            <pre className="text-xs p-2 mt-2 rounded-md overflow-auto">
                              {stream.pipeline_params?.json ??
                                JSON.stringify(stream.pipeline_params, null, 2)}
                            </pre>
                          </div>
                        </DialogContent>
                      </Dialog>
